...
unsigned char code Table_KeyChannel[C_KEY_TOTAL] = {
	...
	C_KEY26_CH, 		
#endif			
#if	((C_KEY_TOTAL-26)>	0)//CCKEY27_USER	
	C_KEY27_CH, 		
#endif			
#if	((C_KEY_TOTAL-27)>	0)//CCKEY28_USER	
	C_KEY28_CH, 		
#endif			
#if	((C_KEY_TOTAL-28)>	0)//CCKEY29_USER	
	C_KEY29_CH, 		
#endif			
#if	((C_KEY_TOTAL-29)>	0)//CCKEY30_USER	
	C_KEY30_CH, 		
#endif
#if	((C_KEY_TOTAL-30)>	0)//CCKEY31_USER	
	C_KEY31_CH,
#endif
#if	((C_KEY_TOTAL-31)>	0)//CCKEY32_USER	
	C_KEY32_CH,
#endif
};
